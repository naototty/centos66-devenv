...
%files
%defattr(-, root, root)
%doc README COPYING ChangeLog LEGAL BSDL COPYING.ja Doxyfile KNOWNBUGS.rb NEWS README README.EXT README.EXT.ja
%doc doc sample tool
...
%changelog
* Mon Aug 17 2015 Naoto Gohko <naoto-gohko@gmo.jp> - 2.1.5-2

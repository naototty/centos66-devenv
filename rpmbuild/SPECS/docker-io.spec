...
%global commit      47496519da9664202d900d3635bb840509fa9647
...
Provides: golang(%{import_path}/autogen/dockerversion) = %{version}-%{release}
...
%pre
getent group dockerroot > /dev/null || %{_sbindir}/useradd -r -d %{_sharedstatedir}/docker -s /sbin/nologin -c "Docker User" dockerroot
exit 0
...
%changelog
* Wed Apr 29 2015 Lokesh Mandvekar <lsm5@fedoraproject.org> - 1.6.0-1
- Update to upstream v1.6.0
- Docker group not created anymore

* Thu Apr 09 2015 Lokesh Mandvekar <lsm5@fedoraproject.org> - 1.5.0-2
- Resolves: rhbz#1176302 - set DOCKER_NOWARN_KERNEL_VERSION=1 in sysconfig
file

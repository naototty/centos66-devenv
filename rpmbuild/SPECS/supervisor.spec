...
%files
%defattr(-,root,root,-)
## [root@dev-iso-upload01 SPECS]# ls ../BUILD/supervisor-3.1.3/
## build  CHANGES.txt  CONTRIBUTORS.txt  COPYRIGHT.txt  docs  LICENSES.txt  MANIFEST.in  PKG-INFO  README.rst  setup.cfg  setup.py  supervisor  supervisor.egg-info  TODO.txt  tox.ini
%doc CHANGES.txt COPYRIGHT.txt README.rst LICENSES.txt TODO.txt docs CONTRIBUTORS.txt
